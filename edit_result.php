...
if (
    !isset($_SESSION['role']) ||
    ($_SESSION['role'] !== 'super' && empty($_SESSION['can_edit_results']))
) {
    ...
    <div class="edit-container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="floor" value="<?php echo htmlspecialchars($contact['floor'] ?? ''); ?>" required>            </div>
            <div class="form-group">
                <label class="labels">Department:</label>
                <input type="text" name="department" value="<?php echo htmlspecialchars($contact['department'] ?? ''); ?>" required>            </div>
            <div class="form-group">
                <label class="labels">Extension (Caller ID):</label>
                <input type="text" name="Caller_ID" value="<?php echo htmlspecialchars($contact['Caller_ID'] ?? ''); ?>" required>            </div>
            <div class="form-group">
